...
import initializeMessagePorts from "src/webextension/list/message-ports";
...
describe("list > message ports", () => {
  ...
  it('handle "account_details_updated"', () => {
    const account = {
      mode: "authenticated",
      uid: "1234",
      email: "eripley@wyutani.com",
    };
    messagePort.postMessage({type: "account_details_updated", account});
