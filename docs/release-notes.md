...
* We updated the visual design and interaction of account actions dropdown in the full editor view to better match Photon ([#524](https://github.com/mozilla-lockbox/lockbox-extension/issues/524))
